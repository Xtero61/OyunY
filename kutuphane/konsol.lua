...
function Konsol:guncelle(dt)
    ...
    if Konsol.durum then
        ...
        if love.keyboard.isPressed("f3") then -- yapıştır
            Konsol.yazi = Konsol.yazi .. "/oyun_kur 30000 10"
        end
        if love.keyboard.isPressed("f4") then -- yapıştır
            Konsol.yazi = Konsol.yazi .. "/baglan 127.0.0.1:30000"
        end
...
function Konsol:arkaplan()
    ...
    love.graphics.polygon("fill", 10, 10 + love.graphics.getHeight() - 30, 16, 15 + love.graphics.getHeight() - 30, 10,
        20 + love.graphics.getHeight() - 30)
end
